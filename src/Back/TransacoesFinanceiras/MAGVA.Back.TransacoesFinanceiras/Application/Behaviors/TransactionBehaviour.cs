...
namespace MAGVA.Back.TransacoesFinanceiras.Application.Behaviors
{
    ...
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        ...
        private readonly TransacoesFinanceirasContext _dbContext;
        ...
        public async Task<TResponse> Handle(TRequest request, CancellationToken cancellationToken, RequestHandlerDelegate<TResponse> next)
        {
            ...
            try
            {
                ...
                await strategy.ExecuteAsync(async () =>
                {
                    ...
                    await _transacoesFinanceirasIntegrationEventService.PublishEventsThroughEventBusAsync(transactionId);
                });
